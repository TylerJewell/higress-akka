...
A `LICENSE-higress` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [higress-group/higress](https://github.com/higress-group/higress), Copyright
the higress-group/higress authors, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../higress-port/specs/SPEC-001-higress.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
